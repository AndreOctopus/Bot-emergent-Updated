...
NOTE: This version uses standard OpenAI SDK instead of emergentintegrations
"""
...
class TradeSignal(BaseModel):
    ...
    take_profit: float
    leverage: int = 3
    position_size_percent: float = 3.0  # % of balance
...
🎯 <b>Daily Target (2.5%):</b> {'REACHED ✅' if stats.target_reached else 'In Progress...'}
"""
        await self.send_message(message)
...
# ============== AI Strategy Engine (OpenAI) ==============

class AIStrategyEngine:
    """AI-powered trading strategy using OpenAI GPT"""
...
{{
    ...
    "reason": "brief explanation"
        ...
        try:
            ...
            sl_percent = decision.get('stop_loss_percent', 1) / 100
            tp_percent = decision.get('take_profit_percent', 1.5) / 100
            ...
            return TradeSignal(
                ...
                position_size_percent=decision.get('position_size_percent', 3)
            )
